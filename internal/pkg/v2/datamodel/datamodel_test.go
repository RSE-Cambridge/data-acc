...
func Test_Session(t *testing.T) {
	...
	expected := `{"Name":"","Revision":0,"Owner":0,"Group":0,"CreatedAt":0,"VolumeRequest":{"MultiJob":false,"Caller":"","TotalCapacityBytes":0,"PoolName":"","Access":0,"Type":0,"SwapBytes":0},"DeleteRequested":false,"StageInRequests":null,"StageOutRequests":null,"AttachHosts":null,"JobVolume":"","MultiJobVolumes":null,"Paths":null,"Allocations":null,"SessionActionPrefix":"","ActualSizeBytes":0,"Error":null}`
